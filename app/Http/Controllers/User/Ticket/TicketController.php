...
class TicketController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $custupdate->direccionentrega = $request->input('direccionentrega');
        $custupdate->firstname = $request->input('firstname');
        $custupdate->lastname = $request->input('lastname');
        $custupdate->tiposolicitante = $request->input('tiposolicitante');
        $custupdate->tipodocumento = $request->input('tipodocumento');
        $custupdate->documento = $request->input('documento');
        $custupdate->razonsocial = $request->input('razonsocial');
        $custupdate->nit = $request->input('nit');
        $custupdate->phone = $request->input('phone');
        $custupdate->municipio = $request->input('municipio');
        $custupdate->update();
        ...
        $ticketData = [
            ...
            'archivo' => $ticket->getMedia('ticket')[0]->getFullUrl(),
            'nombrearchivo' =>  $ticket->getMedia('ticket')[0]->file_name,

        ...
        if($customerfind){
            if($customerfind->userType == 'Guest'){
                ...
                try{
                    ...
                    return response()->json(['success' => 'Porfavor verifique su correo', 'email' => 'exists']);
                }
            ...
            if($customerfind->userType == 'Customer'){
                ...
                return response()->json(['error' => 'Este correo ya existe, porfavor inicie sesión para que pueda crear su PQRSD', 'email' => 'already']);
            }

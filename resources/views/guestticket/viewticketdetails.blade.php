						...
						<div class="col-md-6 justify-content-center mx-auto text-center">
                            ...
                            <div class="card">
                                <div class="card-body p-8 text-center">
									...
									<p class="mt-5 fs-20 leading-norma">Su número de radicado es el siguiente <b>{{$ticket->ticket_id}}</b></p>
									<p>porfavor use su número de radicado para ir consultando la respuesta de su PQRSD</p>

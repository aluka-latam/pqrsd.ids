					...
					if(EmailRegex.test(email)){
						...
						$.ajax({
							...
							success: (data) => {
								...
								$('#alertemailerror').html(' Un código de un solo uso ha sido enviado a su correo electrónico. Porfavor ingrese ese correo a continuación para continuar.')
								$('#verifyottp').show();
							},
